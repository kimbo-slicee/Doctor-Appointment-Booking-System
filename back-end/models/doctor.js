...
const doctorSchema=new mongoose.Schema({
    ...
    speciality:{
        type:String,
        require:[true,"Please Provide Doctor Speciality"]
    },
    degree:{
        type:String,
        require:[true,"please Provide Doctor degree"],
        // Default image
    ...
    experience:{
        type:String,
        require:[true,"please Provide Doctor experience Years"]
    },
    about:{
        type:String,
        require:[true,"please Provide Doctor About "],
        minLength:100
    },
    available:{
        type:Boolean,
    ...
    fees:{
        type:Number,
        require:[true,"Pleas Provide Doctor Fees"]
    ...
    address:{
        ...
        require:[true,"Pleas Provide Doctor Address "]


    },
    data:{
        Type:Number,
        require:[true,"Pleas Provide Doctor Date"]
