...
import {createDoc, login, getAllDoctors, getAllAppointments} from "../controllers/adminController.js";
...
adminRouter.route('/appointments').get(authAdminMiddleware,getAllAppointments);
