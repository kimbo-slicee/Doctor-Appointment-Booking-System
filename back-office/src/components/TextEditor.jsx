...
import {
    ...
    FORMAT_TEXT_COMMAND,
    $createParagraphNode,
    SELECTION_CHANGE_COMMAND, $getRoot, $createTextNode,
} from "lexical";
import {
    $isListNode,
    REMOVE_LIST_COMMAND,
...
function Placeholder() {
    return (
        <div className="w-full pointer-events-none absolute left-2.5 top-4
        inline-block select-none overflow-hidden text-base font-normal text-gray-400">
            Doctor About...
        </div>
    );
}
...
function BlockOptionsDropdownList({
    ...
    const formatNumberedList = (type, payload) => {
        if (blockType !== "ol") {
    ...
    return (
        <List
            className="absolute z-[5] flex flex-col gap-0.5 rounded-3xl border border-blue-gray-50 bg-white p-1"
            ref={dropDownRef}
        >
            <ListItem
    ...
    return (
        ...
        >
            {isEditMode ? (
                ...
                <>
                    <div className="relative box-border flex w-full
                     items-center justify-between rounded-l border-0 bg-white px-3 py-2 font-[inherit] text-gray-900">
                        <Typography
                            as="a"
                            variant="small"
                            color="blue"
