         ...
         <p className=" mb-3 text-center text-primary font-medium text-xl ">ADD NEW DOCTOR</p>
             ...
             <div className="flex flex-col lg:flex-row items-start gap-5 text-gray-600">
                 <div className="w-full flex flex-col gap-4">
                     ...
                     <div className="flex-1 flex flex-col gap-1">
                         <p>Doctor Password</p>
                         <input onChange={e=>setPassword(e.target.value)} type="password" value={password} placeholder="Password" required className="border rounded px-3 py-3"/>
                     </div>
                     <div className="flex-1 flex flex-col gap-1">
                         <p>Experience</p>
                     ...
                     <div className="flex-1 flex flex-col gap-1">
                         ...
                         <div className="flex flex-row gap-5">
                             <div className="inline-flex items-center">
                                 <label className="relative flex items-center cursor-pointer" htmlFor="avliable">
                             ...
                             <div className="inline-flex items-center">
                                 <label className="relative flex items-center cursor-pointer" htmlFor="Not Available">
                                     <input name="Availability" type="radio"
             ...
             <div>
                 ...
                 <textarea onChange={e => setAbout(e.target.value)} value={about}
                           className="w-full px-2 pt-3 border rounded" rows={5} placeholder="write about yourself..."/>
             </div>
